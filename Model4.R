...
for (w in 1:R)
{
  ...
  #################################### Model 4 Setting
  a1<-rep(runif(1,0.8,1),p)
  a2<-rep(runif(1,0.8,1),p)
  a3<-rep(runif(1,0.8,1),p)
  a4<-rep(runif(1,0.8,1),p)
  a5<-rep(runif(1,0.8,1),p)
  a6<-rep(runif(1,0.8,1),p)
  for (i in 1:n)
  {
    
    for (k in 1:(p))
    {
      Y11[k,i]=Mu[k,i]+Alpha1[k,i]+Beta1[k,i]+e1[k,i]+a1[k]*Alpha1[k,i]
      Y12[k,i]=Mu[k,i]+ Alpha1[k,i]+Beta2[k,i]+e2[k,i]+a2[k]*Alpha1[k,i]
      Y13[k,i]=Mu[k,i]+ Alpha1[k,i]+Beta3[k,i]+e3[k,i]+a3[k]*Alpha1[k,i]
      Y21[k,i]=Mu[k,i]+Alpha2[k,i]+Beta1[k,i]+e4[k,i]+a4[k]*Alpha2[k,i]
      Y22[k,i]=Mu[k,i]+ Alpha2[k,i]+Beta2[k,i]+e5[k,i]+a5[k]*Alpha2[k,i]
      Y23[k,i]=Mu[k,i]+ Alpha2[k,i]+Beta3[k,i]+e6[k,i]+a6[k]*Alpha2[k,i]
    }  
    for (k in (p+1):(2*p))
    {
      Y11[k,i]=Mu[k,i]+Alpha1[k,i]+Beta1[k,i]+e1[k,i]
      Y12[k,i]=Mu[k,i]+ Alpha1[k,i]+Beta2[k,i]+e2[k,i]
      Y13[k,i]=Mu[k,i]+ Alpha1[k,i]+Beta3[k,i]+e3[k,i]
      Y21[k,i]=Mu[k,i]+Alpha2[k,i]+Beta1[k,i]+e4[k,i]
      Y22[k,i]=Mu[k,i]+ Alpha2[k,i]+Beta2[k,i]+e5[k,i]
      Y23[k,i]=Mu[k,i]+ Alpha2[k,i]+Beta3[k,i]+e6[k,i]
    }  
  }
  ...
  for (k in 1:4)
  {
    ...
    Index1=order(depth_col1,decreasing=T)
    Index2=order(depth_col2,decreasing=T)
    Index3=order(depth_col3,decreasing=T)
...
fbplot(Grand[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,5.8),main="Model 4 (Median) variable 1",ylab="Grand Effect",xlab="t")
lines(t,4*t,lty=6,col = "green",lwd=1.8)
fbplot(Row1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-4,3.5),main="Model 4 (Median) variable 1 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.6)^2,lty=6,col = "green",lwd=1.8)
fbplot(Col1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-6.7,6.5),main="Model 4 (Median) variable 1",ylab="Column Effect 1",xlab="t")
lines(t,-3*cos(2*pi*t),lty=6,col = "green",lwd=1.8)
##################
## plot of MBD estimation for variable 1
fbplot(mar_Grand[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,6),main="Model 4 (Median) variable 1",ylab="Grand Effect",xlab="t")
lines(t,4*t,lty=6,col = "green",lwd=1.8)
fbplot(mar_Row1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-4,3.5),main="Model 4 (Median) variable 1 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.6)^2,lty=6,col = "green",lwd=1.8)
fbplot(mar_Col1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-6.7,6.5),main="Model 4 (Median) variable 1",ylab="Column Effect 1",xlab="t")
lines(t,-3*cos(2*pi*t),lty=6,col = "green",lwd=1.8)
#######################
######### plot of mean estimation for variable 1

fbplot(mean_Grand[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,6),main="Model 4 (Mean) variable 1",ylab="Grand Effect",xlab="t")
lines(t,4*t,lty=6,col = "green",lwd=1.8)
fbplot(mean_Row1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-4,3.5),main="Model 4 (Mean) variable 1 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.6)^2,lty=6,col = "green",lwd=1.8)
fbplot(mean_Col1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-6.7,6.5),main="Model 4 (Mean) variable 1",ylab="Column Effect 1",xlab="t")
lines(t,-3*cos(2*pi*t),lty=6,col = "green",lwd=1.8)

########################
############ plot of MSBD estimation for variable 2
fbplot(Grand[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,8),main="Model 4 (Median) variable 2 ",ylab="Grand Effect",xlab="t")
lines(t,5*t,lty=6,col = "green",lwd=1.8)
fbplot(Row1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3.5,3),main="Model 4 (Median) variable 2 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.3)^2,lty=6,col = "green",lwd=1.8)
fbplot(Col1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-8,9),main="Model 4 (Median) variable 2 ",ylab="Column Effect 1",xlab="t")
lines(t,-3*sin(2*pi*t),lty=6,col = "green",lwd=1.8)
#########################
######### plot of MBD estimation for variable 2
fbplot(mar_Grand[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,8),main="Model 4 (Median) variable 2 ",ylab="Grand Effect",xlab="t")
lines(t,5*t,lty=6,col = "green",lwd=1.8)
fbplot(mar_Row1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3.5,3),main="Model 4 (Median) variable 2 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.3)^2,lty=6,col = "green",lwd=1.8)
fbplot(mar_Col1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-8,9),main="Model 4 (Median) variable 2 ",ylab="Column Effect 1",xlab="t")
lines(t,-3*sin(2*pi*t),lty=6,col = "green",lwd=1.8)
#############################
########### plot of mean estimation for variable 2
fbplot(mean_Grand[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,8),main="Model 4 (Mean) variable 2 ",ylab="Grand Effect",xlab="t")
lines(t,5*t,lty=6,col = "green",lwd=1.8)
fbplot(mean_Row1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3.5,3),main="Model 4 (Mean) variable 2 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.3)^2,lty=6,col = "green",lwd=1.8)
fbplot(mean_Col1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-8,9),main="Model 4 (Mean) variable 2 ",ylab="Column Effect 1",xlab="t")
lines(t,-3*sin(2*pi*t),lty=6,col = "green",lwd=1.8)
#################################
