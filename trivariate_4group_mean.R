...
### trivariate case
### We assume y is a 3*p by n matrix
triv_group_test<-function(y,n1,n2,n3,n4)
{
  p<-y[1]/3
...
critical_triv_group_test<-function(y,n1,n2,n3,n4)
{
  p<-y[1]/3
  whole_mean<-apply(y,1,mean)
  len<-1:(n1+n2+n3+n4)
...
compare_triv_group<-function(lambda,critical)
{
