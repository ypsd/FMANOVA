...
fbplot(Grand[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,5.8),main="Model 3 (Median) variable 1",ylab="Grand Effect",xlab="t")
lines(t,4*t,lty=6,col = "green",lwd=1.8)
fbplot(Row1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-4,3.5),main="Model 3 (Median) variable 1 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.6)^2,lty=6,col = "green",lwd=1.8)
fbplot(Col1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-6.7,6.5),main="Model 3 (Median) variable 1",ylab="Column Effect 1",xlab="t")
lines(t,-3*cos(2*pi*t),lty=6,col = "green",lwd=1.8)
##################
## plot of MBD estimation for variable 1
fbplot(mar_Grand[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,6),main="Model 3 (Median) variable 1",ylab="Grand Effect",xlab="t")
lines(t,4*t,lty=6,col = "green",lwd=1.8)
fbplot(mar_Row1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-4,3.5),main="Model 3 (Median) variable 1 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.6)^2,lty=6,col = "green",lwd=1.8)
fbplot(mar_Col1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-6.7,6.5),main="Model 3 (Median) variable 1",ylab="Column Effect 1",xlab="t")
lines(t,-3*cos(2*pi*t),lty=6,col = "green",lwd=1.8)
#######################
######### plot of mean estimation for variable 1

fbplot(mean_Grand[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,6),main="Model 3 (Mean) variable 1",ylab="Grand Effect",xlab="t")
lines(t,4*t,lty=6,col = "green",lwd=1.8)
fbplot(mean_Row1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-4,3.5),main="Model 3 (Mean) variable 1 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.6)^2,lty=6,col = "green",lwd=1.8)
fbplot(mean_Col1[1:p,],method='MBD',x=t,xlim=c(0,1),ylim=c(-6.7,6.5),main="Model 3 (Mean) variable 1",ylab="Column Effect 1",xlab="t")
lines(t,-3*cos(2*pi*t),lty=6,col = "green",lwd=1.8)

########################
############ plot of MSBD estimation for variable 2
fbplot(Grand[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,8),main="Model 3 (Median) variable 2 ",ylab="Grand Effect",xlab="t")
lines(t,5*t,lty=6,col = "green",lwd=1.8)
fbplot(Row1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3.5,3),main="Model 3 (Median) variable 2 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.3)^2,lty=6,col = "green",lwd=1.8)
fbplot(Col1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-8,9),main="Model 3 (Median) variable 2 ",ylab="Column Effect 1",xlab="t")
lines(t,-3*sin(2*pi*t),lty=6,col = "green",lwd=1.8)
#########################
######### plot of MBD estimation for variable 2
fbplot(mar_Grand[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,8),main="Model 3 (Median) variable 2 ",ylab="Grand Effect",xlab="t")
lines(t,5*t,lty=6,col = "green",lwd=1.8)
fbplot(mar_Row1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3.5,3),main="Model 3 (Median) variable 2 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.3)^2,lty=6,col = "green",lwd=1.8)
fbplot(mar_Col1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-8,9),main="Model 3 (Median) variable 2 ",ylab="Column Effect 1",xlab="t")
lines(t,-3*sin(2*pi*t),lty=6,col = "green",lwd=1.8)
#############################
########### plot of mean estimation for variable 2
fbplot(mean_Grand[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3,8),main="Model 3 (Mean) variable 2 ",ylab="Grand Effect",xlab="t")
lines(t,5*t,lty=6,col = "green",lwd=1.8)
fbplot(mean_Row1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-3.5,3),main="Model 3 (Mean) variable 2 ",ylab="Row Effect 1",xlab="t")
lines(t,-4*(t-0.3)^2,lty=6,col = "green",lwd=1.8)
fbplot(mean_Col1[(p+1):(2*p),],method='MBD',x=t,xlim=c(0,1),ylim=c(-8,9),main="Model 3 (Mean) variable 2 ",ylab="Column Effect 1",xlab="t")
lines(t,-3*sin(2*pi*t),lty=6,col = "green",lwd=1.8)
#################################
